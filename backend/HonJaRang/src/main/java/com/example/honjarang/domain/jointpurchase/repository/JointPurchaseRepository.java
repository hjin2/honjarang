...
public interface JointPurchaseRepository extends JpaRepository<JointPurchase, Long> {
    ...
    Page<JointPurchase> findAllByIsCanceledFalseAndDeadlineAfterAndDistanceLessThanAndTargetPersonCountGreaterThanOrderByCreatedAtDesc(LocalDateTime now, Double latitude, Double longitude, Pageable pageable);
