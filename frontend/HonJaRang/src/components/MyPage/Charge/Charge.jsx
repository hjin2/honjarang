    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between">
        <div className="space-y-2">
          ...
          <div className="w-20 h-8 border-2 rounded-lg flex items-center text-xs">
            {point}P
          </div>
        </div>
        <div>
        ...
        <div className="space-y-2">
          ...
          <div className="w-20 h-8 border-2 rounded-lg flex items-center text-xs">
            {' '}
            {Number(point) + Number(activeRadio)}P
          </div>
        </div>
      </div>
      <div className="mt-20 flex justify-between">
        <button className="main1-button w-24" onClick={newTabClick}>
          결제하기
        </button>
        {/* <button className='main1-button w-24' onClick={popUp}>
          결제하기
        </button> */}
        <button className="main5-button w-24" onClick={onClickCloseButton}>
          취소하기
        </button>
      </div>
    </div>
