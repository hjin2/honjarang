...
export default function Delivery({id, isMe}) {
	...
	useEffect(()=>{
    axios.get(`${API.USER}/page-join`, {params:{size:4}, headers})
      .then((res)=>{
	...
	useEffect(()=>{
    axios.get(`${API.USER}/joint-deliveries-participating`, {params:{page:joinCurrentPage, size:4},headers})
      .then((res) => {
        console.log(res)
  ...
  useEffect(() => {
    axios.get(`${API.USER}/page-writing/${id}`,{params:{size:4},headers})
      .then((res) =>{
        console.log(res.data)
	...
	useEffect(() => {
    axios.get(`${API.USER}/joint-deliveries-writer/${id}`,{params:{size:4,page:writeCurrentPage},headers})
      .then((res) => {
        console.log(res.data)
