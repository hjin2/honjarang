...
export default function Edit({ modalState, setModalState }) {
  ...
  const [latitude, setLatitude] = useState(
    useSelector((state) => state.userinfo.latitude),
  );
  const [longitude, setLongitude] = useState(
    useSelector((state) => state.userinfo.longitude),
  );
      ...
      <div className="p-14">
        ...
        <div className="mt-10 space-y-2">
          ...
          <div className="cursor-pointer text-xs text-main3">
            <Link to="/findpassword/changepassword">비밀번호 변경</Link>
          </div>
          <div
            className="cursor-pointer text-xs text-main5"
