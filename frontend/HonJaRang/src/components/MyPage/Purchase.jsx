...
export default function Purchase({id, isMe}) {
	...
	useEffect(()=>{
    axios.get(`${API.USER}/page-joined-purchase`, {params:{size:4}, headers})
      .then((res)=>{
	...
	useEffect(()=>{
    axios.get(`${API.USER}/jointpurchase-participating`, {params:{page:joinCurrentPage, size:4},headers})
      .then((res) => {
        console.log(res)
  ...
  useEffect(() => {
    axios.get(`${API.USER}/page-joint-purchase/${id}`,{params:{size:4},headers})
      .then((res) =>{
        console.log(res.data)
	...
	useEffect(() => {
    axios.get(`${API.USER}/jointpurchase-writer/${id}`,{params:{size:4,page:writeCurrentPage},headers})
      .then((res) => {
        console.log(res.data)
