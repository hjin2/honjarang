  ...
  return (
    <div className="mb-2">
      <div>
        <label
          htmlFor="email"
          className="font-semibold text-lg text-main2 mb-1"
        >
          이메일
        </label>
        <div className="flex">
          ...
          {Manual ? (
            ...
            <select
              name="email"
              id="email"
              className=" border border-gray2 rounded-lg block w-60 h-10 p-2 m-0 focus:outline-main2"
              value={address}
              onChange={onSelect}
              disabled={EmailDisalbed}
            >
          ...
          {EmailDisalbed ? (
            ...
            <button
              className="w-32 h-10 main4-full-button text-base ml-2"
        ...
        {emailCheck && (
          <Verify_check email={email} ChangeEmailValid={ChangeEmailValid} />
        )}
      </div>
    </div>
  );
