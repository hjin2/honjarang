...
const ArticleCreate = () => {
  ...
  const saveArticle = () => {
    ...
    axios
      .post(`${API.POST}`, formData, { headers })
      .then((res) => {
        console.log(res);
  ...
  return (
    <div className="border rounded-lg max-w-2xl mx-auto mt-10 pb-3 p-5">
      ...
      <div className="py-3">
        ...
        <TextField handleTitle={handleTitle} />
      </div>
      <div className="py-3">
      ...
      <div className="py-3 flex justify-between">
        <button onClick={saveArticle} className="main1-full-button w-32">
          작성 완료
        </button>
        <button
          onClick={() => {
          ...
          className="main5-full-button w-32"
        >
          목록
        </button>
      </div>
