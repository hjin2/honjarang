...
export const ArticleDetail = () => {
  ...
  const addComment = () =>{
    ...
    axios.post(`${API.POST}/${id}/comments`,data,{headers})
      .then((res)=>{
        fetchComments()
      })
  ...
  const fetchUser = useCallback((userId) =>{
    axios.get(`${API.USER}/info`,{params:{id:userId}, headers})
      .then((res)=>{
  ...
  const notice = () =>{
    axios.put(`${API.POST}/${id}/notice`,[],{params:{id:id},headers})
      .then((res) => {
        console.log(res)
        handleNotice()
      })
  ...
  const handleLike = () =>{
    axios.post(`${API.POST}/${id}/like`,[],{headers})
      .then((res) =>{
        console.log(res)
        setIsLiked(!isLiked)
        if(isLiked){
