...
export default function ArticleUpdate() {
  ...
  const editArticle = () => {
    ...
    console.log;
    axios
      .put(`${API.POST}/${id}`, formData, { headers })
      .then((res) => {
        console.log(res);
  ...
  return (
    <div className="border rounded-lg max-w-2xl mx-auto mt-10 pb-3 p-5">
      <div className="py-3">
        ...
        <form action="" value="카테고리">
          <select
            ...
            className="border border-gray3 rounded-lg h-8 w-24"
          >
      ...
      <div className="py-3 flex justify-between">
        <button onClick={editArticle} className="main1-full-button w-24">
          수정하기
        </button>
        <button
          onClick={() => {
          ...
          className="main5-full-button w-24"
        >
          취소
        </button>
      </div>
