      ...
      <div>
        <div>
          ...
          {Check ? (
            <button
              disabled={Check}
              className="main5-full-button ml-4 w-24 h-10"
            >
              전송완료
            </button>
          ) : (
            <button
              ...
              className="main1-full-button ml-4 w-24 h-10"
            >
              인증번호 전송
            </button>
          )}
          {errorMessage ? (
            <div className="text-xs text-main5 font-semibold">
              {errorMessage}
            </div>
          ) : (
            <div></div>
        ...
        {Check ? (
          <div>
            ...
            <span className="font-semibold text-lg ml-2 flex items-center">
