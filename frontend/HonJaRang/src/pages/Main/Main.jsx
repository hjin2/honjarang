    ...
    <div className=" h-screen">
      {isLogged ? (
        ...
        <div className="flex m-4 w-5/6 mx-auto pb-5 justify-between">
          ...
          <div>
            <Link to="/login">
              <button className="font-semibold font-ImcreSoojin text-lg my-2 mx-4">
                로그인
              </button>
            </Link>
            <Link to="/signup">
      ...
      {isLogged ? <div className="h-10"></div> : null}
      {/* 공동배달, 공동구매 */}
      <div className="flex p-10 py-32 my-5 flex-row bg-main4 bg-opacity-75 justify-around">
        <div>
          ...
          <p className="text-xl text-gray4 mt-4 font-Suite">
            근처 자취생들과 함께 이용하며
            <br />
            다양한 선택과 절약으로 더욱 풍성한
            <br />
      ...
      <div className="text-gray2 text-sm">
        {' '}
        Icons made by{' '}
        <a href="https://www.flaticon.com/authors/catkuro" title="캣쿠로">
          {' '}
          캣쿠로{' '}
        </a>{' '}
        from{' '}
