...
export default function PurchaseDetail() {
  ...
  axios.get(`${API.PURCHASES}/${id}/applicants`, {headers})
    .then((res) => {
      // console.log(res.data)
      if(res.data){
  ...
  const deletePurchase = () =>{
    axios.delete(`${API.PURCHASES}/${id}`,{headers})
      .then((res)=>{
        console.log(res)
        navigate('/market')
      })
  ...
  const CancelPurchase = () =>{
    axios.delete(`${API.PURCHASES}/${id}/applicants`, {headers})
      .then((res) => {
        console.log(res)
        setIsPurchase(false)
      })
  ...
  const handleCheck = () =>{
    console.log(id)
    axios.put(`${API.PURCHASES}/${id}/receive`,[],{headers})
      .then((res) =>{
        console.log(res)
