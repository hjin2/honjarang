...
export default function Purchase({id, isMe}) {
  ...
  useEffect(() => {
    axios.get(`${URL}/api/v1/users/page-joint-purchase/${id}`,{params:{size:4},headers})
      .then((res) =>{
        console.log(res.data)
	...
	useEffect(() => {
    axios.get(`${URL}/api/v1/users/jointpurchase-writer/${id}`,{params:{size:4,page:writeCurrentPage},headers})
      .then((res) => {
        console.log(res.data)
